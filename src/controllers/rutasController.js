...
controller.eliminarTurno =  (req, res) => {
    req.getConnection((err,conn)=>{
        ...
        conn.query('DELETE FROM turnos  WHERE paciente = ? and dia = ? and hora = ?',[user[0].email,dia,hora],(err,rows)=>{
...
controller.PagePublicacionesiController = (req, res) => {
