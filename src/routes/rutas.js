...
router.get('/verVeterinariasTurnoCargadas',controller.verVeterinariasTurnoCargadas)
router.get('/agregarVeterinariaDeTurno',controller.agregarVetTurno)
router.post('/guardarVeterinaria',controller.agregarVeterinariaDeTurno)
router.get('/agregarDiaTurnoVeterinariaVentana',controller.agregarDiaTurnoVeterinariaVentana)
